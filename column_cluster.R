...
apply_class <- function(spots_frame, gene){
  ...
  #table(Br_1_1_0[2: nrow(Br_1_1_0), ]$y - Br_1_1_0$y) #check the difference btw the columns/y values to check for the columns
  ...
  interaction.plot(Br_1_1_0$Column, Br_1_1_0$Layer, response = Br_1_1_0$Expr, fun = mean, main = paste(gene, 'mean Expression going through the y-axis', sep = '_'),
  ...
  #table(Br_1_2_0[2: nrow(Br_1_2_0), ]$y - Br_1_2_0$y) # 92 
  ...
  interaction.plot(Br_1_2_0$Column, Br_1_2_0$Layer, response = Br_1_2_0$Expr, fun = mean, main = paste(gene, 'mean Expression going through the y-axis', sep = '_'),
                  col = colors, lty = 1, lwd = 1, legend = T, xlab = 'X-column', ylab = 'Mean Expression', xpd = F,
  ...
  #table(Br_1_1_300[2:nrow(Br_1_1_300), ]$y - Br_1_1_300$y) # 115
  ...
  interaction.plot(Br_1_1_300$Column, Br_1_1_300$Layer, response = Br_1_1_300$Expr, fun = mean, main = paste(gene, 'mean Expression going through the y-axis', sep = '_'),
                   col = colors, lty = 1, lwd = 1, legend = T, xlab = 'X-column', ylab = 'Mean Expression', xpd = F,
  ...
  #table(Br_1_2_300[2:nrow(Br_1_2_300), ]$y - Br_1_2_300$y)#53 but there are low values that stain this value
  ...
  interaction.plot(Br_1_2_300$Column, Br_1_2_300$Layer, response = Br_1_2_300$Expr, fun = mean, main = paste(gene, 'mean Expression going through the y-axis', sep = '_'),
                   col = colors, lty = 1, lwd = 1, legend = T, xlab = 'X-column', ylab = 'Mean Expression', xpd = F,
  ...
  #table(Br_2_1_0[2: nrow(Br_2_1_0), ]$y - Br_2_1_0$y) #101
  ...
  interaction.plot(Br_2_1_0$Column, Br_2_1_0$Layer, response = Br_2_1_0$Expr, fun = mean, main = paste(gene, 'mean Expression going through the y-axis', sep = '_'),
                   col = colors, lty = 1, lwd = 1, legend = T, xlab = 'X-column', ylab = 'Mean Expression', xpd = F,
  ...
  #table(Br_2_2_0[2: nrow(Br_2_2_0), ]$y - Br_2_2_0$y) # 98
  ...
  interaction.plot(Br_2_2_0$Column, Br_2_2_0$Layer, response = Br_2_2_0$Expr, fun = mean, main = paste(gene, 'mean Expression going through the y-axis', sep = '_'),
                   col = colors, lty = 1, lwd = 1, legend = T, xlab = 'X-column', ylab = 'Mean Expression', xpd = F,
  ...
  #table(Br_2_1_300[2:nrow(Br_2_1_300), ]$y - Br_2_1_300$y) # 101
  ...
  interaction.plot(Br_2_1_300$Column, Br_2_1_300$Layer, response = Br_2_1_300$Expr, fun = mean, main = paste(gene, 'mean Expression going through the y-axis', sep = '_'),
                   col = colors, lty = 1, lwd = 1, legend = T, xlab = 'X-column', ylab = 'Mean Expression', xpd = F,
  ...
  #table(Br_2_2_300[2:nrow(Br_2_2_300), ]$y - Br_2_2_300$y)#98 but there are low values that stain this value
  ...
  interaction.plot(Br_2_2_300$Column, Br_2_2_300$Layer, response = Br_2_2_300$Expr, fun = mean, main = paste(gene, 'mean Expression going through the y-axis', sep = '_'),
                  col = colors, lty = 1, lwd = 1, legend = T, xlab = 'X-column', ylab = 'Mean Expression', xpd = F,
  ...
  #table(Br_3_1_0[2: nrow(Br_3_1_0), ]$y - Br_3_1_0$y) #63 but there are lots of low values that stain this value
  ...
  interaction.plot(Br_3_1_0$Column, Br_3_1_0$Layer, response = Br_3_1_0$Expr, fun = mean, main = paste(gene, 'mean Expression going through the y-axis', sep = '_'),
                   col = colors, lty = 1, lwd = 1, legend = T, xlab = 'X-column', ylab = 'Mean Expression', xpd = F,
  ...
  #table(Br_3_2_0[2: nrow(Br_3_2_0), ]$y - Br_3_2_0$y) # 62 but there are lots of low values that stain this value
  ...
  interaction.plot(Br_3_2_0$Column, Br_3_2_0$Layer, response = Br_3_2_0$Expr, fun = mean, main = paste(gene, 'mean Expression going through the y-axis', sep = '_'),
                   col = colors, lty = 1, lwd = 1, legend = T, xlab = 'X-column', ylab = 'Mean Expression', xpd = F,
  ...
  #table(Br_3_1_300[2:nrow(Br_3_1_300), ]$y - Br_3_1_300$y) # 62 but there are lots of low values that stain this value
  ...
  interaction.plot(Br_3_1_300$Column, Br_3_1_300$Layer, response = Br_3_1_300$Expr, fun = mean, main = paste(gene, 'mean Expression going through the y-axis', sep = '_'),
                   col = colors, lty = 1, lwd = 1, legend = T, xlab = 'X-column', ylab = 'Mean Expression', xpd = F,
  ...
  #table(Br_3_2_300[2:nrow(Br_3_2_300), ]$y - Br_3_2_300$y)#59 but there are low values that stain this value 
  ...
  interaction.plot(Br_3_2_300$Column, Br_3_2_300$Layer, response = Br_3_2_300$Expr, fun = mean, main = paste(gene, 'mean Expression going through the y-axis', sep = '_'),
                   col = colors, lty = 1, lwd = 1, legend = T, xlab = 'X-column', ylab = 'Mean Expression', xpd = F,
